...
Fish<-read.csv("FishCommSppIndiv_SE.csv")  #This is the raw fish species data.
SiteLength<-read.csv("FishCommSampling_SE.csv") #This contains sampling effort.
Sitewidth <- read.csv("CrossSectionalInfo_SE.csv") #This contains reach length.
...
#various plots.
write.csv(FishSiteMetrics, "C:/Users/ccheri/Documents/R/Summaries/Park Fish Summaries/TAPR/TAPR_fish_sitemetrics.csv") #You will need to
write.csv(SpMetricsWithNames, "C:/Users/ccheri/Documents/R/Summaries/Park Fish Summaries/TAPR/TAPR_fish_speciesmetrics.csv") #change the name and 
                                                                                                                             #address accordingly.
