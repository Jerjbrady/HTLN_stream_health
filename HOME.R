...
Fish<-read.csv("~/code for aquatic visualizer/CSVs/Seined Parks/HOME/HOME/HOME/HOME_qsel_Export_FishCommSppIndiv_SE.csv")  #This is the raw fish species data.
SiteLength<-read.csv("~/code for aquatic visualizer/CSVs/Seined Parks/HOME/HOME/HOME/HOME_qsel_Export_FishCommSampling_SE.csv") #This contains sampling effort.
Sitewidth <- read.csv("~/code for aquatic visualizer/CSVs/Seined Parks/HOME/HOME/HOME/HOME_qsel_Export_CrossSectionalInfo_SE.csv") #This contains reach length.
...
#various plots.
write.csv(FishSiteMetrics, "~/code for aquatic visualizer/CSVs/Seined Parks/HOME/HOME/HOME/HOME_fish_sitemetrics.csv") #You will need to
write.csv(SpMetricsWithNames, "~/code for aquatic visualizer/CSVs/Seined Parks/HOME/HOME/HOME/HOME_fish_speciesmetrics.csv") #change the name and 
#address accordingly.