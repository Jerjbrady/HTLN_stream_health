...
Fish<-read.csv("~/code for aquatic visualizer/CSVs/electrofish/GWCA/GWCA/GWCA/GWCA_qsel_Export_FishCommSppIndiv_EF.csv")  #This is the raw fish species data.
Effort<-read.csv("~/code for aquatic visualizer/CSVs/electrofish/GWCA/GWCA/GWCA/GWCA_qsel_Export_FishCommSampling_EF.csv") #This contains sampling effort.
SiteWidth<-read.csv("~/code for aquatic visualizer/CSVs/electrofish/GWCA/GWCA/GWCA/GWCA_qsel_Export_CrossSectionalInfo_EF.csv") #This contains reach width.
...
write.csv(FishSiteMetrics, "~/code for aquatic visualizer/CSVs/electrofish/GWCA/GWCA/GWCA/GWCA_fish_sitemetrics.csv")
write.csv(SpMetricsWithNames, "~/code for aquatic visualizer/CSVs/electrofish/GWCA/GWCA/GWCA/GWCA_fish_speciesmetrics.csv") #change the name and 
